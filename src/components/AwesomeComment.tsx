...
export default function AwesomeComment() {
  ...
  async function loadAndInit() {
    // 动态加载 CSS
    const cssUrl = 'https://unpkg.com/@roudanio/awesome-comment@0.10.6/dist/style.css';
    ...
    try {
      ...
      const [authModule, commentModule] = await Promise.all([
        ...
        import(/* webpackIgnore: true */ 'https://unpkg.com/@roudanio/awesome-comment@0.10.6/dist/awesome-comment.js'),
      ]);
