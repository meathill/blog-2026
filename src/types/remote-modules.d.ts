...
declare module 'https://unpkg.com/@roudanio/awesome-comment@0.10.3/dist/awesome-comment.js' {
  const AwesomeComment: {
    init: (
      root: HTMLElement,
      options: { turnstileSiteKey?: string; postId: string; apiUrl: string; awesomeAuth: unknown },
    ) => void;
  };
