/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: edb3d3be86f5584ae4a8231e7de892d5)
// Runtime types generated with workerd@1.20260114.0 2026-01-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface Env {
    NEXT_PUBLIC_SITE_URL: 'https://meathill.com';
    WP_ORIGIN_IP: '164.90.146.101';
    WP_HOSTNAME: 'blog.meathill.com';
    WORDPRESS_API_URL: 'https://164.90.146.101/wp-json/wp/v2';
    NODEJS_ENV: string;
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<Cloudflare.Env, 'NEXT_PUBLIC_SITE_URL' | 'WP_ORIGIN_IP' | 'WP_HOSTNAME' | 'WORDPRESS_API_URL' | 'NODEJS_ENV'>
    > {}
}
