/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: b812cc64c0b5299a2ca6ba9725b9df8b)
...
declare namespace Cloudflare {
  interface Env {
    ...
    WORDPRESS_API_URL: 'http://164.90.146.101/wp-json/wp/v2';
    NODEJS_ENV: string;
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<Cloudflare.Env, 'NEXT_PUBLIC_SITE_URL' | 'WP_ORIGIN_IP' | 'WORDPRESS_API_URL' | 'NODEJS_ENV'>
    > {}
}
