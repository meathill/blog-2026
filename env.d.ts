/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv env.d.ts` (hash: bd27b502fb39dc5b6b2a91aba9ced002)
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        'NEXT_PUBLIC_SITE_URL' | 'WORDPRESS_API_URL' | 'NODEJS_ENV' | 'CF_ACCESS_CLIENT_ID' | 'CF_ACCESS_CLIENT_SECRET'
      >
    > {}
}
